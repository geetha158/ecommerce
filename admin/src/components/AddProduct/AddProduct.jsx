    ...
    <div className='add_product'>
        ...
        <div className='add_product_itemfield'>
            <label htmlFor="file-input">
                 <img src={image?URL.createObjectURL(image):upload_area} alt="" className='add_product_thumnail_img'/>
            </label>
            <input onChange={imageHandler} type="file" name='image' id='file-input' hidden />
        </div>
        <button onClick={AddProduct} className='add_product_btn'>ADD</button>
    </div>
